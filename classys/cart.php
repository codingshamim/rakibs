...
<?php
$cartId = $_SESSION['uniqueId'];

$selCart2 = "select * from cart where userId = '$cartId' order by id desc";
$cartQuery2 = mysqli_query($conn,$selCart2);
...
if(isset($_GET['removeCart'])){
  ...
  $remvCart = "DELETE FROM `cart` WHERE id = '$removeId'";
  if(mysqli_query($conn,$remvCart)){
    $succ = true;
    $succMsg = "Cart item Deleted Succesfully";
  }
}
?>
...
while($cartItem = mysqli_fetch_assoc($cartQuery2)){
...
$productPrice =  $cartProduct['pr'];
$productQ  =   $cartItem['quan'];
$subTotal = $productPrice * $productQ;
  
$prIdsTwo = $cartItem['id'];
                  ...
                  <div class="item-wishlist">
                    ...
                    <div class="wishlist-product">
                      <div class="product-wishlist">
                        <div class="product-image"><a href="shop-single-product.html"><img src="myClassy/assets/imgs/product/<?php echo $cartProduct['thumb'] ?>" alt="Ecom"></a></div>
                        <div class="product-info"><a href="shop-single-product.html">
                            <h6 class="color-brand-3"><?php echo $cartProduct['title'] ?></h6></a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500"> (65)</span></div>
                        </div>
                      </div>
                    </div>
                    <div class="wishlist-price">
                      <h4 class="color-brand-3 font-md-bold"><?php echo $headers['symbol'] ?><?php echo $cartProduct['pr'] ?>/-</h4>
                    </div>
                    <div class="wishlist-status">
                      <div class="box-quantity">
                        ...
                        <div class="input-quantity">
                          ...
                          <input readonly min="1" max="10" class="font-xl color-brand-3" type="text" value="<?php echo $cartItem['quan'] ?>" name="quantity"><button class="btn minus-cart d-flex justify-content-center align-items-center" style="font-size:20px" type="button">
                          -
                          </button><button type="button" class="btn plus-cart d-flex justify-content-center align-items-center" style="font-size:20px">+</button>
                       
                        </div>
                        <input type="hidden" value="<?php echo $prIdsTwo ?>" name="cartId">
                      </div>
                    </div>
                    <div class="wishlist-action">
                      <h4 class="color-brand-3 font-md-bold"><?php echo $headers['symbol'] ?><?php echo  $subTotal ?>/-</h4>
                    </div>
                    <div class="wishlist-remove d-flex justify-content-center align-items-center flex-column">
                      <a class="btn btn-delete" href="cart.php?removeCart=<?php echo $cartItem['id'] ?>">Remove</a>
                      <button type="submit" name="updateCart" class="d-flex justify-content-center align-items-center btn btn-buy mb-10" >Update</button>
                      </form>
                  </div>
                  </div>
                  <?php 
...
if(isset($_POST['updateCart'])){
  ...
  $cartIds = mysqli_real_escape_string($conn,$_POST['cartId']);
  $update = "UPDATE `cart` SET `quan` = '$quantity' WHERE `cart`.`id` = '$cartIds'";
