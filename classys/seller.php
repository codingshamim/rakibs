...
if(isset($_POST['seller'])){
    ...
    $sellerSql = "INSERT INTO `seller` (`name`, `email`, `phone`, `country`) VALUES ( '$fName', '$email', '$phoneNb', '$country')";
    if(mysqli_query($conn,$sellerSql)){
...
?>
    ...
    <option value="ZW">Zimbabwe</option>
                ...
                <div class="form-group">
                  <input name="seller" class="font-md-bold btn btn-buy" type="submit" value="Apply">
                </div>
